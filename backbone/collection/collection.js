                        ...
                        { 
                          ...
                          div.appendChild(enclose);
                           ...
                           for (var i=0; i<count; i++)
                           {
                             ...
                             Rest('https://github.com/adenzil/blog/tree/gh-pages/ap.php?action=get_page&per_page='+per_page+'&page='+pg_no+'&query='+q + str,"GET",a);  
                              ...
                              count=0;
                            Rest('https://github.com/adenzil/blog/tree/gh-pages/ap.php?action=get_page&per_page='+per_page+'&page='+pg_no+'&query='+q + '&tag='+tag,"GET",a);  
